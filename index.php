...
<head>
  ...
  <script src="https://kit.fontawesome.com/97098226a0.js" crossorigin="anonymous"></script>
...
<body>
  <nav>
    <ul>
      ...
      <li>
        <a href="https://www.linkedin.com/in/antoniosotopwr/" target="_blank"><i class="fa-brands fa-linkedin"
            aria-hidden="true"></i><span class="sr-only">LinkedIn</span></a>
      </li>
      <li>
        <a href="https://github.com/antoniosotopwr" target="_blank"><i class="fa-brands fa-github-square"
            aria-hidden="true"></i><span class="sr-only">GitHub</span></a>
      </li>
      <li>
        <a href="https://www.hackerrank.com/snakepower0199" target="_blank"><i class="fa-brands fa-hackerrank"
            aria-hidden="true"></i><span class="sr-only">HackerRank</span></a>
      </li>
      <li>
        <a href="https://www.behance.net/antoniosotopwr" target="_blank"><i class="fa-brands fa-behance-square"
            aria-hidden="true"></i><span class="sr-only">Behance</span></a>
      </li>
      <li>
  ...
  <section id="intro">
    ...
    <p>
      ...
      knowledge in: <br />HTML, CSS, Javascript, SQL, Python, C#, ASP.NET Blazor, Bootstrap and
      Figma.
    </p>
    <p>
      Currently, I'm working at
      <a href="https://www.tenaris.com/en" target="_blank">Tenaris Tamsa </a>as Trainee in IT.
    </p>
  </section>
    ...
    <section id="projects">
      ...
      <article>
        <div class="text">
          ...
          <h3>Eco-Search</h3>
          <p class="blackbox">
            As a result of a course on UX/UI design, I made
            a project about a shopping mobile app using whimsical, optimal workshop, canvas, and Figma.
            <a href="https://www.behance.net/antoniosotopwr" target="_blank"><br>Link to the behance</a> and
            <a href="https://www.figma.com/file/oZHHGMRk0Dvjx6tXEO9ceV/Dise%C3%B1o-advanced-V2?node-id=0%3A1"
              target="_blank">link to the prototype in Figma </a>.
          </p>
        ...
        <img src="img/mockup.png" alt="mockup ux/ui project" />
      </article>
    </section>
  </div>

  <div class="gradient"></div>
  <h2 id="projects-title">Another projects</h2>
  <section id="flex-projects">
